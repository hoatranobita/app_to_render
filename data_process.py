...
df2 = df2[df2['state_name'] == 'Iowa']
df = pd.merge(df, df2[['county', 'county_fips']], on='county', how='left')
df.drop_duplicates(subset=['invoice_and_item_number'], keep='last',inplace=True)
print(df)
