                ...
                dbc.Col([
                    dbc.Card([
                        dbc.CardBody([
                            ...
                            dcc.Graph(figure={},id='season_chart_3'),
                        ])
                    ])
...
@app.callback(Output('season_chart_3', 'figure'),
...
def update_graph(theme):
    ...
    fig_1_1.update_layout(template=template_from_url(theme), margin=dict(l=0, r=0, t=0, b=0))
...
def update_graph(n_clicks_1,theme,start_date_3,end_date_3):
    ...
    fig_2_1.update_layout(template=template_from_url(theme), margin=dict(l=0, r=0, t=0, b=0))
    ...
    fig_3_1.update_traces(marker_color='rgba(50, 171, 96, 0.6)', marker_line_color='rgba(50, 171, 96, 1.0)',
                      marker_line_width=1,texttemplate='%{text:,.2f}', textposition='outside')
    fig_3_1.update_layout(template=template_from_url(theme), margin=dict(l=0, r=0, t=0, b=0))
    ...
    fig_4_1.update_traces(marker_color='rgba(50, 171, 96, 0.6)', marker_line_color='rgba(50, 171, 96, 1.0)',
                      marker_line_width=1,texttemplate='%{text:,.2f}', textposition='outside')
    fig_4_1.update_layout(template=template_from_url(theme), margin=dict(l=0, r=0, t=0, b=0))
    ...
    fig_5_1.update_traces(marker_color='rgba(50, 171, 96, 0.6)', marker_line_color='rgba(50, 171, 96, 1.0)',
                      marker_line_width=1,texttemplate='%{text:,.2f}', textposition='outside')
    fig_5_1.update_layout(template=template_from_url(theme), margin=dict(l=0, r=0, t=0, b=0))
...
def update_graph(n_clicks,theme,items,start_date_4,end_date_4):
