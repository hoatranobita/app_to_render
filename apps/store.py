...
def update_graph(n_clicks,theme,stores,start_date_5,end_date_5):
...
@app.callback([Output('bubble_map_1','figure'),
               Output('bubble_map_2','figure')],
              [Input('btn_5','n_clicks'),
               Input(ThemeChangerAIO.ids.radio("theme"), "value")],
              [State('my-date-picker-range_5', 'start_date'),
              State('my-date-picker-range_5', 'end_date')]
...
def update_graph(n_clicks,theme,start_date_5, end_date_5):
    ...
    fig_5.update_layout(template=template_from_url(theme),margin={"r":0,"t":0,"l":0,"b":0})
    ...
    fig_6 = px.scatter_mapbox(dff_9_2,
                          ...
                          center={"lat": 42.01604, "lon": -92.91157},
                          hover_name="store_name")
    fig_6.update_layout(template=template_from_url(theme),margin={"r":0,"t":0,"l":0,"b":0})
    return fig_5, fig_6
